 ...
 <!-- Javascript -->
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="logo span4">
                        <h1><a href="">Edit Publisher <span class="red">.</span></a></h1>
                    </div>
        ...
        <div class="register-container container">
            <div class="row">
           <% Publisher p=(Publisher)request.getAttribute(MessageConstant.Publisher); %>
                <div class="register span6">
                    <form  id="regform" action="<%=UrlConstant.Admin_SERVLET %>" method="post">
                        <h2><span class="red"><strong>Edit Publisher</strong></span></h2>
                        <label for="name">Name</label>
                       <input type="text" name="publishername" value=<%=p.getName() %>>
                        <label for="location">Location</label>
                        <input type="text" name="loc" value="<%=p.getLoc() %>">
