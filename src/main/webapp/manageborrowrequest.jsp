...
<body>
	...
	<div class="top2">
		...
		<div class="title" >
			<h3>Manage Borrow-Request Interface</h3>
		</div>
...
<hr>
   <div id="borrowreq">
   <% int sno=1;
      List<BorrowRecordBean>list=AdminDao.QueryBorrowRecord(); 
   %>
   ...
   <td><input type="text" value="<%=brb.getBorrowdate()%>"></td>
   <td><input type="text" value="<%=brb.getShouldreturndate()%>"></td>
   <td><form action="<%=UrlConstant.Admin_SERVLET %>" method="post">
     ...
     <input type="submit" name="submit" value="approveborrow">
   </form>
   </td>
   <td>
   <form action="<%=UrlConstant.Admin_SERVLET %>" method="post">
     ...
     <input type="hidden" name="userid"  value="<%=brb.getUserid() %>">
     <input type="hidden" name="bookname" value="<%=brb.getBookname() %>">
     <input type="submit" name="submit" value="rejectborrow">
   </form>
